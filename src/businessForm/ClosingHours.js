...
class ClosingHours extends React.Component {
  state = {
    age: '',
    open: false,
  };
    ...
    return (
      ...
      <form autoComplete="off">
        <FormControl className={classes.formControl}>
          <InputLabel htmlFor="demo-controlled-open-select">Select Closing Hours</InputLabel>
          <Select
...
ClosingHours.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ClosingHours);